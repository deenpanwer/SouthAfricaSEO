  ...
  return (
    <footer className="bg-white">
      <div className="container mx-auto px-6 pt-16 pb-8">
        ...
        {/* Footer Callouts */}
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 bg-enviro-green text-white p-10 md:p-12 rounded-2xl mb-16">
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-enviro-text/80"><Phone className="w-4 h-4 text-enviro-green"/> 519-500-8854</li>
              <li className="flex items-center gap-2 text-enviro-text/80"><Mail className="w-4 h-4 text-enviro-green"/> jordan@enviropainting.ca</li>
