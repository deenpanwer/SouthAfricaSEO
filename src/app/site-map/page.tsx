...
export default function HumanReadableSitemap() {
    ...
    return (
        <div className="container mx-auto px-4 py-10 text-gray-800">
            ...
            <section className="bg-gray-50 rounded-lg p-6 shadow-sm mb-8">
                <h2 className="text-2xl font-semibold text-gray-700 mb-6 pb-4 border-b border-gray-200">City Pages</h2>
                <ul className="space-y-3">
            ...
            <section className="bg-gray-50 rounded-lg p-6 shadow-sm">
                <h2 className="text-2xl font-semibold text-gray-700 mb-6 pb-4 border-b border-gray-200">Blog Posts</h2>
                <ul className="space-y-3">
                    {BLOG_POSTS.map((post) => (
                        <li key={post.slug}>
