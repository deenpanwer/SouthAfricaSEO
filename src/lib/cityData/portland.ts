  ...
  whyChoosePoints: [
    {
      ...
      description: 'Our SEO strategies are meticulously designed for sustainable organic growth and a demonstrable return on investment for your Portland business. We focus on long-term gains, not quick, unsustainable fixes, using data to drive every decision.'
    },
    {
      icon: 'Lightbulb',
      title: 'Deep Portland Market & Audience Knowledge',
      description: 'We understand the nuances of the Portland SEO landscape and local consumer search behavior, including the importance of community and sustainability. This local expertise allows us to tailor strategies that truly resonate and outperform competitors.'
    },
    {
      icon: 'ShieldCheck',
      title: 'Ethical, Transparent & Collaborative SEO',
      description: 'We practice honest, white-hat SEO techniques, providing clear, consistent reporting on all campaigns targeting the Portland area. We see ourselves as an extension of your team, working together towards shared goals.'
    },
  ],
  awards: {
    clutch: {
