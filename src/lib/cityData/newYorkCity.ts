...
export const newYorkCityData: CityPageData = {
  ...
  heroData: {
    ...
    heroDescription: 'TRAC delivers cutting-edge SEO strategies meticulously tailored for the fast-paced, hyper-competitive New York City market. We understand that visibility in NYC requires more than just basic optimization; it demands a sophisticated, multi-faceted approach. Our services encompass comprehensive technical SEO to ensure your site performs flawlessly, hyper-local targeting across all five boroughs to connect you with your immediate community, sophisticated content marketing that captures the NYC zeitgeist, and authoritative link acquisition to build your domain\'s power. We empower your NYC business to capture high-value organic traffic, enhance brand authority, and achieve significant, measurable ROI through strategic and sustained search engine optimization efforts. Our team continually analyzes market trends and algorithm updates to keep your New York City business at the forefront of digital innovation. Let TRAC be your guide to conquering the search rankings in the city that never sleeps.',
    heroImage: {
