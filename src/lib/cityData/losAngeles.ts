...
export const losAngelesData: CityPageData = {
  ...
  heroData: {
    ...
    heroDescription: 'Unlock the immense potential of your Los Angeles business with TRAC\'s expert SEO services. LA\'s diverse and competitive market demands a sophisticated approach. We specialize in creating custom SEO campaigns that drive targeted organic traffic, significantly improve search engine rankings, and deliver tangible, measurable results. From comprehensive local SEO targeting specific LA neighborhoods to advanced e-commerce optimization and content strategies that resonate with Southern California audiences, TRAC covers all your SEO needs.',
    heroImage: {
