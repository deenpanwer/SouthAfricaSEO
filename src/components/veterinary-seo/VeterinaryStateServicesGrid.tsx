...
import type { VeterinaryStateServiceItem } from '@/types';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';

interface VeterinaryStateServicesGridProps {
  headline: string;
  subheadline: string;
...
export function VeterinaryStateServicesGrid({ headline, subheadline, services, stateName }: VeterinaryStateServicesGridProps) {
  return (
