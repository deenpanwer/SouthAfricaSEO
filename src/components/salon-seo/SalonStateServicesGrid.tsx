...
import type { SalonStateServiceItem } from '@/types';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';

interface SalonStateServicesGridProps {
  headline: string;
  subheadline: string;
...
export function SalonStateServicesGrid({ headline, subheadline, services, stateName }: SalonStateServicesGridProps) {
  return (
