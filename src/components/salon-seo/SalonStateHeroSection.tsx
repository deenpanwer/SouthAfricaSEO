...
import type { SalonStateHeroData } from '@/types';
import { SalonStateHeroForm } from './SalonStateHeroForm';
...
interface SalonStateHeroSectionProps {
  stateData: SalonStateHeroData;
  stateName: string;
}

export function SalonStateHeroSection({ stateData, stateName }: SalonStateHeroSectionProps) {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="lg:order-2">
            <SalonStateHeroForm stateName={stateName} formTitle={formTitle.replace('[StateName]', stateName)} />
          </div>
          <div className="lg:order-1 text-center lg:text-left">
            ...
            <Modal isOpen={showVideo} onClose={() => setShowVideo(false)}>
              <iframe
                ...
                allowFullScreen
                title={`TRAC Salon & Spa SEO for ${stateName}`}
              ></iframe>
            </Modal>
