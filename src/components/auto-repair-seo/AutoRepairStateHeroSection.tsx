...
import type { AutoRepairStateHeroData } from '@/types';
import { AutoRepairStateHeroForm } from './AutoRepairStateHeroForm';
...
interface AutoRepairStateHeroSectionProps {
  stateData: AutoRepairStateHeroData;
  stateName: string;
}

export function AutoRepairStateHeroSection({ stateData, stateName }: AutoRepairStateHeroSectionProps) {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="lg:order-2">
            <AutoRepairStateHeroForm stateName={stateName} formTitle={formTitle.replace('[StateName]', stateName)} />
          </div>
          <div className="lg:order-1 text-center lg:text-left">
            ...
            <div className="relative aspect-video rounded-lg overflow-hidden shadow-lg mb-8 mx-auto lg:mx-0 max-w-xl cursor-pointer group" onClick={() => setShowVideo(true)}>
              <Image
                ...
                height={400}
                layout="responsive"
                data-ai-hint={heroImage.dataAiHint || "auto repair shop"}
                priority
              />
            ...
            <Modal isOpen={showVideo} onClose={() => setShowVideo(false)}>
              <iframe
                ...
                allowFullScreen
                title={`TRAC Auto Repair SEO for ${stateName}`}
              ></iframe>
            </Modal>
