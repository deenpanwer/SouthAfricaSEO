...
import type { AutoRepairStateServiceItem } from '@/types';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';

interface AutoRepairStateServicesGridProps {
  headline: string;
  subheadline: string;
...
export function AutoRepairStateServicesGrid({ headline, subheadline, services, stateName }: AutoRepairStateServicesGridProps) {
  return (
