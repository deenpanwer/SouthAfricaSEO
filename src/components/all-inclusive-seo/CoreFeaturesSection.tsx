// src/components/all-inclusive-seo/CoreFeaturesSection.tsx
"use client";
...
const CORE_FEATURES_CSS = `
  :root {
    ...
    --sat: 69%;
    --white: hsl(0, 0%, 100%);
    --purple-primary: rgba(132, 0, 255, 1); /* Keeping for consistency, will override glow for light theme */
    --purple-glow: rgba(132, 0, 255, 0.2);
    --purple-border: rgba(132, 0, 255, 0.8);
    --border-color: #392e4e;
    --background-dark: #060010; /* Keeping for overall dark theme */
    color-scheme: dark; /* Explicitly dark theme for the section */
  }
  ...
  .magic-bento-card {
    ...
    background: var(--background-dark); /* Default, will be overridden by card.color */
    font-weight: 300;
    overflow: hidden;
    transition: all 0.3s ease;
    color: var(--white); /* Ensure white text for dark theme */
  ...
  .magic-bento-card__content {
    display: flex;
    flex-direction: column; /* Added to stack title and description */
    position: relative;
    color: inherit; /* Inherit color from parent to ensure dark text */
  }
