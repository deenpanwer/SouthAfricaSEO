  ...
  return (
    <section className="py-16 lg:py-24 bg-gray-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-4">The Trac Growth Insider</h2>
        <p className="text-center text-gray-600 mb-12 max-w-xl mx-auto">
          Actionable insights on marketing, strategy, and growth—distilled from our work with hundreds of successful businesses.
        </p>
