...
export const DigitalExpertiseSection = () => {
  const expertiseItems = [
    { title: "SEARCH ENGINE OPTIMIZATION (SEO)", href: "/services/seo", icon: Search, description: "Trac Internet Marketing Agency is an award-winning SEO company that provides goal-oriented SEO services. Let our SEO experts help your business climb the rankings and attract ready-to-buy customers with on-point keyword research, content creation and on-page optimization." },
    { title: "PAY-PER-CLICK (PPC) MANAGEMENT", href: "/services/ppc", icon: TrendingUp, description: "Reach your customers quickly and with precision with a data-driven PPC campaign. Our PPC Specialists are AdWords certified, so you can rest easy knowing your campaign is in the hands of professionals. Thrive is a Google Premier Partner and Microsoft Advertising Select Partner Agency." },
    { title: "SOCIAL MEDIA MARKETING", href: "/services/social-media-marketing", icon: Users, description: "Ready to expand and market to your audiences on social media? We build social media campaigns to help your business grow and engage your followers. Our digital marketing agency identifies your goals, performs competitor benchmarking and evaluates your customers' online behavior." },
    { title: "WEB DESIGN AND DEVELOPMENT", href: "/services/web-design-and-development", icon: Settings, description: "Build a website that drives traffic, leads and sales. Our web design company offers custom web development services tailored to your specific business needs. We provide ongoing website maintenance to ensure your site is secure, backed up and performing optimally." },
    { title: "CONTENT WRITING", href: "/services/content-writing", icon: Briefcase, description: "Your website's content is crucial: it's the foundation of your SEO and the reason many people visit your site. Entrust your content creation with Trac's professional copywriters and reap the benefits of optimized, high-quality web content." },
    { title: "EMAIL MARKETING", href: "/services/email-marketing", icon: MailIcon, description: "How many emails from businesses do you delete every day? Choose Trac and let's make your email marketing campaigns stand out and work for your business. We create personalized email newsletters to keep your emails out of spam folders and encourage your customers to take your desired action." },
    { title: "REPUTATION MANAGEMENT", href: "/services/reputation-management", icon: Award, description: "Your reviews and online reputation can make or break your success online. Improve your reputation and reap the rewards with help from our internet marketing agency. We partner with top review management software providers to streamline your online reputation management (ORM) processes." },
    { title: "ECOMMERCE OPTIMIZATION", href: "/services/ecommerce-optimization", icon: BarChart2, description: "Generate more product sales and revenue through your eCommerce website. Our internet marketing company offers eCommerce SEO and eCommerce PPC solutions to drive top-of-funnel traffic to your website. We generate more product reviews, optimize your product pages and personalize your marketing automation." },
    { title: "AMAZON MARKETING SERVICES (AMS)", href: "/services/amazon-marketing", icon: ShoppingBagIcon, description: "Are you looking to list your products on the biggest eCommerce website in the world? Thrive is an Amazon marketing agency that can help you take advantage of the growing platform. We offer turnkey Amazon marketing services, including Amazon SEO and Amazon PPC." },
  ];
    ...
    <section className="py-16 lg:py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
          Trac offers data-driven digital marketing services aimed to deliver results that matter. We have a team of search, social, content, web and creative experts focused on client growth.
        </p>
          ...
          {expertiseItems.map((item, index) => (
            <div key={index} className="p-6 border border-gray-200 rounded-lg">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-md font-semibold text-gray-800 hover:text-orange-500 transition-colors">
