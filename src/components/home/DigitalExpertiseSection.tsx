...
export const DigitalExpertiseSection = () => {
  const expertiseItems = [
    ...
    { title: "CONTENT WRITING", icon: Briefcase, description: "Your website\\'s content is crucial: it\'s the foundation of your SEO and the reason many people visit your site. Entrust your content creation with Trac\\'s professional copywriters and reap the benefits of optimized, high-quality web content." },
