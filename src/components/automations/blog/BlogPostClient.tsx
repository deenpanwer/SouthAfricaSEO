      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8"> {/* Wider container */}
        ...
        <header className="mb-8 md:mb-12">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center text-ph-light-gray text-sm sm:text-base mb-4 space-y-1 sm:space-y-0 sm:space-x-4">
            ...
            <span>{new Date(postData.date).toISOString().split('T')[0]}</span>
            <span className="hidden sm:inline">•</span>
            <span>{readTime}</span>
          </div>
        ...
        {/* Featured Image */}
        {postData.image && (
          <div className="mb-8 relative w-full h-72 sm:h-96 md:h-[500px] lg:h-[600px] rounded-lg overflow-hidden"> {/* More prominent image */}
            <Image
              src={postData.image}
        ...
        {/* Article Content */}
        <article className="prose prose-invert prose-lg mx-auto text-ph-light-gray max-w-none"> {/* max-w-none for full width */}
