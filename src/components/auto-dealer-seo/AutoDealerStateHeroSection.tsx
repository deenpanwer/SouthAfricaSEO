...
import type { AutoDealerStateHeroData } from '@/types';
import { AutoDealerStateHeroForm } from './AutoDealerStateHeroForm';
...
interface AutoDealerStateHeroSectionProps {
  stateData: AutoDealerStateHeroData;
  stateName: string;
}

export function AutoDealerStateHeroSection({ stateData, stateName }: AutoDealerStateHeroSectionProps) {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="lg:order-2">
            <AutoDealerStateHeroForm stateName={stateName} formTitle={formTitle.replace('[StateName]', stateName)} />
          </div>
          <div className="lg:order-1 text-center lg:text-left">
            ...
            <div className="relative aspect-video rounded-lg overflow-hidden shadow-lg mb-8 mx-auto lg:mx-0 max-w-xl cursor-pointer group" onClick={() => setShowVideo(true)}>
              <Image
                ...
                height={400}
                layout="responsive"
                data-ai-hint={heroImage.dataAiHint || "car dealership"}
                priority
              />
            ...
            <Modal isOpen={showVideo} onClose={() => setShowVideo(false)}>
              <iframe
                ...
                allowFullScreen
                title={`TRAC Auto Dealer SEO for ${stateName}`}
              ></iframe>
            </Modal>
