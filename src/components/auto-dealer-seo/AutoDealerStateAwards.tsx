          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-10">
            ...
            <div className="flex-grow text-center md:text-left">
              ...
              <p className="mb-4 leading-relaxed text-muted-foreground">
                TRAC consistently earns top ratings on Clutch for {stateName} auto dealer SEO. Check out <a href="https://clutch.co/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">our reviews</a>.
              </p>
            </div>
          </div>
