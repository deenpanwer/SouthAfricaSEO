...
import type { GymStateServiceItem } from '@/types';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';

interface GymStateServicesGridProps {
  headline: string;
  subheadline: string;
...
export function GymStateServicesGrid({ headline, subheadline, services, stateName }: GymStateServicesGridProps) {
  return (
