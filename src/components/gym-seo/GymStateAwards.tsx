...
import type { GymStateAwardData } from '@/types';

interface GymStateAwardsProps {
  clutchAward: GymStateAwardData;
  upcityAward: GymStateAwardData;
  stateName: string;
}
...
const AWARD_BADGES_STRIP_ALT = 'Various digital marketing and fitness industry SEO awards';

const clutchCategories = [
  'Gym & Fitness Center SEO',
  'Local SEO for Studios',
  'Health & Wellness Marketing',
  'Lead Generation for Memberships',
];

export function GymStateAwards({ clutchAward, upcityAward, stateName }: GymStateAwardsProps) {
  return (
        ...
        <div className="flex flex-col gap-12 md:gap-16">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-10">
            <div className="flex-shrink-0 mx-auto md:mx-0">
              <Image
                ...
                data-ai-hint="award logo gym seo"
              />
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-10">
            <div className="flex-shrink-0 mx-auto md:mx-0">
              <Image
                ...
                height={200}
                className="w-auto h-auto"
                data-ai-hint="excellence award badge gym seo"
              />
            </div>
            <div className="flex-grow text-center md:text-left">
              ...
              <p className="leading-relaxed text-muted-foreground">
                UpCity recognizes TRAC for leading gym and fitness SEO services in {stateName}. Explore <a href="https://upcity.com/" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">our portfolio</a>.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 md:mt-12 text-center">
            <Image src={AWARD_BADGES_STRIP_IMAGE} alt={AWARD_BADGES_STRIP_ALT} width={800} height={100}
              ...
              data-ai-hint="collection award badges gym fitness"
            />
          </div>
        </div>
      </div>
