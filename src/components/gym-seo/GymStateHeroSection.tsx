...
import type { GymStateHeroData } from '@/types';
import { GymStateHeroForm } from './GymStateHeroForm';
...
interface GymStateHeroSectionProps {
  stateData: GymStateHeroData;
  stateName: string;
}

export function GymStateHeroSection({ stateData, stateName }: GymStateHeroSectionProps) {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="lg:order-2">
            <GymStateHeroForm stateName={stateName} formTitle={formTitle.replace('[StateName]', stateName)} />
          </div>
          <div className="lg:order-1 text-center lg:text-left">
            ...
            <div className="relative aspect-video rounded-lg overflow-hidden shadow-lg mb-8 mx-auto lg:mx-0 max-w-xl cursor-pointer group" onClick={() => setShowVideo(true)}>
              <Image
                ...
                height={400}
                layout="responsive"
                data-ai-hint={heroImage.dataAiHint || "gym fitness"}
                priority
              />
            ...
            <Modal isOpen={showVideo} onClose={() => setShowVideo(false)}>
              <iframe
                ...
                allowFullScreen
                title={`TRAC Gym & Fitness SEO for ${stateName}`}
              ></iframe>
            </Modal>
